		...
		<div>
			<div class="pull-left">
				<span class="post-tools">
					<a component="post/reply" href="#" class="no-select <!-- IF !privileges.topics:reply -->hidden<!-- ENDIF !privileges.topics:reply -->"><i class="fa fa-angle-double-left" aria-hidden="true"></i>[[topic:reply]]</a>
