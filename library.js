...
library.init = function(params, callback) {
	...
	app.get('/admin/plugins/orami', middleware.admin.buildHeader, renderAdmin);
	app.get('/api/admin/plugins/orami', renderAdmin);
...
library.getThemeConfig = function(config, callback) {
	...
	meta.settings.get('orami', function(err, settings) {
		config.hideSubCategories = settings.hideSubCategories === 'on';
		config.hideCategoryLastPost = settings.hideCategoryLastPost === 'on';
		config.enableQuickReply = settings.enableQuickReply === 'on';
		config.slider = settings.slider;
		config.mainLogo = settings.mainLogo;
	});
...
function renderAdmin(req, res, next) {
	res.render('admin/plugins/orami', {});
}
